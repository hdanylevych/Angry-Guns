...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// </param>
        public static AsyncOperation LoadLevel(int levelNumber, LoadSceneMode mode = LoadSceneMode.Single)
        {
            if (PhotonHandler.AppQuits)
            {
                return null;
        ...
        /// </param>
        public static AsyncOperation LoadLevel(string levelName, LoadSceneMode mode = LoadSceneMode.Single)
        {
            if (PhotonHandler.AppQuits)
            {
                return null;
